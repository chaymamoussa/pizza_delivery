...
class OrderCreateListView(generics.GenericAPIView):
    ...
    def post(self, request):
        data= request.data
        serializer=self.serializer_class(data=data)#serializer will valid the data
        user=request.user#acces to the user
...
class OrderDetailView(generics.GenericAPIView):
    ...
    def get(self,request, order_id):
        order =get_object_or_404(Order,pk=order_id)#this function take the model which in our case is Order and the primary key which is order_id
